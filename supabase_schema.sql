...
drop policy if exists "profiles are readable by anon" on public.profiles;
create policy "profiles are readable by anon"
on public.profiles
for select
to anon, authenticated
using (true);

drop policy if exists "likes are readable by anon" on public.likes;
create policy "likes are readable by anon"
on public.likes
for select
to anon, authenticated
using (true);

drop policy if exists "matches are readable by anon" on public.matches;
create policy "matches are readable by anon"
on public.matches
for select
to anon, authenticated
using (true);reate extension if not exists "pgcrypto";
...
create table if not exists public.matches (
  ...
  constraint matches_order check (user_
